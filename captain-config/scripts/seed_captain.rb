...
scenarios_data = [
  ...
  },
  {
    ...
    instruction: <<~INST
      ...
      • بعد جلب الحالة، اعرض التفاصيل بشكل منظم وأنيق:
        - رقم الطلب: ...
        - الحالة الحالية: ...
        - المدينة: ...
        - الموعد المتوقع: ...
      • إذا كانت الحالة "قيد التصنيع"، اطمئن العميل بلطف موضحاً أن المنتج يُصنع خصيصاً له، وأن المدة المتوقعة 30-60 يوماً.
      • إذا تعذّر إيجاد الطلب، اعتذر بلباقة واطلب التأكد من الرقم.
