...
scenarios_data = [
  ...
  },
  {
    ...
    instruction: <<~INST
      ...
      • أوقات عمل خدمة العملاء البشرية: الأحد إلى الخميس، ٩ صباحاً - ٦ مساءً. الإجازة الأسبوعية: الجمعة والسبت. خارج هذه الأوقات المساعد الآلي متاح لمساعدتك.
  ...
  },
  {
    ...
    instruction: <<~INST
      ...
      "يسعدنا تحويلك لأحد مختصينا، وسيتواصل معك قريباً خلال أوقات العمل (الأحد–الخميس، ٩ص–٦م). شكراً لثقتك في كواي داو."
