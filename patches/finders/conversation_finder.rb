class ConversationFinder
  ...
  def filter_by_status
    ...
    # QAYDAO patch (2026-05-05): support comma-separated multi-status filtering.
    # Example: status='open,pending' returns conversations with either status.
    # Backwards-compatible: single status (e.g. 'open') still works exactly as before.
